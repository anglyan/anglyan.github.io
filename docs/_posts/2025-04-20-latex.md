...
![PDF output of a latex document](/assets/images/latex_sample.png){: width="250" .center-image}
...
Incluso si mi primera versión de un trabajo es en Word (por ejemplo porque tus colaboradores no
trabajan con LaTeX), antes de enviar un manuscrito lo suelo convertir en LaTeX y uso el template del
