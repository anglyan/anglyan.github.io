...
las diferentes partes del texto para diferenciar los códigos del contenido. Algunas de las
distribuciones de LaTeX vienen con una serie de programas instalados, que incluyen editores
específicos para LaTeX. 

Uno que uso prácticamente a diario es [LaTeXiT](https://www.chachatelier.fr/latexit/),
